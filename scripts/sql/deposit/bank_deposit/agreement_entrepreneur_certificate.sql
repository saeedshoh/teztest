SELECT
    ...
    passports.tin as pp_director_tin,
...
FROM bank_accounts
         ...
         LEFT JOIN
             (select passports.*, entrepreneurs.client_id, entrepreneurs.name as entre_name
              from entrepreneurs
                       INNER JOIN individuals ON entrepreneurs.individual_id = individuals.id and entrepreneurs.client_id = ${client_id}
